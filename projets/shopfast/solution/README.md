...
python -m uvicorn shopfast.main:app --reload   # http://127.0.0.1:8000/docs
python -m pytest -q                            # tests + couverture (échoue si < 85 %)
python -m mypy shopfast                         # --strict, 0 erreur
```
