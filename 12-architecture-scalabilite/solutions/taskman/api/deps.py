...
from taskman.domain.events import EventPublisher
from taskman.outbox import OutboxRepository, SqlAlchemyOutboxRepository
...
def get_task_service(
    ...
    return TaskService(tasks, uow=session, actor=user, cache=cache, outbox=outbox, events=events)
